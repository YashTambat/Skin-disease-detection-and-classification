...
title=tk.Label(root, text="__Login Here__", font=("Times new roman", 30, "bold","italic"),bd=5,bg="white",fg="#7D0552")
title.place(x=530,y=120,width=250)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=400,y=210)
